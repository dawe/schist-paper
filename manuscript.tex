...
\caption[]{Analysis of a mixture of 5 known cell lines. (A) UMAP embedding colored and labeled by cell line identity. H1975 cells (orange) show two distinct groups reflecting an internal heterogeneity. (B) }\label{FigureTian}
\end{figure}
...
\textcolor{red}{TO BE WRITTEN} Used Splatter [ref], more sensitivity, less precision (Fig. \ref{Figure_DE})
