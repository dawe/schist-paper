...
\caption[]{Analysis of hematopoietic differentiation. (A) Low dimensional embedding of single cells coloured by original cell type and pseudotime. (B) Cells are coloured according to the nSBM grouping at level 1 of the hierarchy, next to a radial tree representation of the same model.}\label{Figure_Hemato_Supp}
\end{figure}
\clearpage
...
\begin{figure}[htbp]
\centering
\includegraphics[keepaspectratio,width=\textwidth,height=0.9\textheight]{FigureOptimalLevel.png}
